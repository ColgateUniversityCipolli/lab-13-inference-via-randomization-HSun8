...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in boot(data = further.data, statistic = boot.mean, R = R): could not find function "{}boot"{}}}\begin{alltt}
\hlcom{# closer}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in boot(data = closer.data, statistic = boot.mean, R = R): could not find function "{}boot"{}}}\begin{alltt}
\hlcom{# diff}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in boot(data = diff.data, statistic = boot.mean, R = R): could not find function "{}boot"{}}}\begin{alltt}
\hlcom{# CI}
\hlcom{# further}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in boot.ci(further.helper, type = "{}bca"{}): could not find function "{}boot.ci"{}}}\begin{alltt}
\hlcom{# closer}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in boot.ci(diff.helper, type = "{}bca"{}): could not find function "{}boot.ci"{}}}\end{kframe}
\end{knitrout}
